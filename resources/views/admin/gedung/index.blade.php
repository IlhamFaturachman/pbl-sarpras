...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <div class="d-flex align-items-center gap-2" style="max-width: 100%;">
            ...
            <button type="button" data-bs-toggle="modal" data-bs-target="#createGedung" class="btn btn-outline-primary btn-sm"  style="height: 42px; align-items: center;">
        ...
        <table class="table table-striped">
            <thead class="table-primary">
                <tr>
                    ...
                    <th style="font-weight: bold;" class="text-center">Aksi</>
                </tr>
            </thead>
            <tbody class="table-border-bottom-0">
                @forelse($gedungs as $gedung)
                    <tr>
                        <td>{{ $loop->iteration + ($gedungs->firstItem() - 1) }}</td>
                        <td>{{ $gedung->kode }}</td>
                        <td>{{ $gedung->nama }}</td>
